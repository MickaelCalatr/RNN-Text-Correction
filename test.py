...
var0 = {"1x": contS, "12x": contM, "24x": contL}
contS = ["x1"]
contM = ["x12", "x6x2", "x2x6x"]
contL = ["x24", "x2x12"]
# In[3]:
...
training, testing = train_test_split(good_sentences, test_size = 0.15, shuffle=False)#random_state = 2)
    ...
    while i < len(sentence):
        ...
        if random < threshold:
            ...
            # ~33% chance an extra lower case letter will be added to the sentence
                ...
                # noisy_sentence.replace("e", "000000")
...
def get_batches(sentences, batch_size, threshold):
    """Batch sentences, noisy sentences, and the lengths of their sentences together.
       With each epoch, sentences will receive n ew mistakes"""
